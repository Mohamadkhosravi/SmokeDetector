...
#define C16_BUZZ_SET_WIDTH		1000
#define C16_BUZZ_SET_DUTY		100
...
#define C_INTERRESIST_DELAY		40		//Delay of internal resistance detection
...
#define C16_HUSH_DELAY			20		//Hush delay
#define C_NOR_DELAY				0		//LED flash period
...
#define C_SM_COV_VAL			102		//Voltage compensation threshold
	...
	#define C_T_AD_ERR_H 		85
	//Compensate threshold for temperature AD(8bit)
	#define C_T_AD_DATA_L1		5		//Low temperature level 2   : AD<L1
	#define C_T_AD_DATA_L2		6		//Low temperature level 1   : L1<AD<L2
	#define C_T_AD_DATA_L3		25		//The normal temperature AD : L2<AD<L3
	#define C_T_AD_DATA_L4		54		//High temperature level 1  : L3<AD<L4. And AD>L4 is High temperature level 2
